  ...
  return (
    <header className="mb-8 space-y-6">
      <div className="flex gap-4 flex-row md:items-top md:justify-between">
        <div className="max-w-2xl space-y-4">
          ...
          <p className="text-sm text-slate-300 sm:text-base">
            Arrange photo grids in seconds. Upload your shots, adjust the layout, and export high-resolution sheets
      ...
      <nav className="flex gap-2">
        <NavLink
          to="/"
          className={({ isActive }) => `${linkBaseClass} ${isActive ? linkActiveClass : 'text-slate-300'}`}
          end
        >
          Builder
        </NavLink>
